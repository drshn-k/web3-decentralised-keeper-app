...
import { idlFactory } from './dekeeper_frontend.did.js';
export { idlFactory } from './dekeeper_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DEKEEPER_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dekeeper_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dekeeper_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dekeeper_frontend.did.js")._SERVICE>}
 */
export const dekeeper_frontend = createActor(canisterId);
