...
import { idlFactory } from './dekeeper_backend.did.js';
export { idlFactory } from './dekeeper_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DEKEEPER_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dekeeper_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dekeeper_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dekeeper_backend.did.js")._SERVICE>}
 */
export const dekeeper_backend = createActor(canisterId);
